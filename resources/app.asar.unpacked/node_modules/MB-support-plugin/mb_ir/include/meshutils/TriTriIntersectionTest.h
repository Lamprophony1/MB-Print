/*
   Code taken from: http://webee.technion.ac.il/cgm/Computer-Graphics-Multimedia/Software/TriangleIntersection/code.cpp
   ...
   "A fast triangle to triangle intersection test for collision detection"
    ...
    You are free to use the code but cite the paper.
     ...
     Main procedures:
        ...
        int tri_tri_intersect3D (double *C1, double *P1, double *P2,
   ...
   tri_tri_intersect3D - C1 is a vertex of triangle A. P1,P2 are the two
   edges originating from this vertex.

        D1 is a vertex of triangle B. P1,P2 are the two edges
        originating from this vertex.
        Returns zero for disjoint triangles and non-zero for intersection.

   coplanar_tri_tri - This procedure for testing coplanar triangles for
   intersection is taken from Tomas Moller's algorithm.
   See article "A Fast Triangle-Triangle Intersection Test",
   Journal of Graphics Tools, 2(2), 1997
   V1,V2,V3 are vertices of one triangle with normal N. U1,U2,U3 are
   vertices of the other triangle.

 */

#ifndef INCLUDE_MESHUTILS_TRITRIINTERSECTIONTEST_H_
#define INCLUDE_MESHUTILS_TRITRIINTERSECTIONTEST_H_
...
int tri_tri_intersect3D(double *C1, double *P1, double *P2,
  ...
  bool alpha1_legal = false, alpha2_legal = false;
  double SF = 0.;
  bool beta1_legal = false, beta2_legal = false;
  ...
  if ((dq1 == 0) && (dq2 == 0)) {
    if (dr != 0) {
      ...
      // We use the coplanar test of Moller which takes
      // the 6 vertices and 2 normals as input.
      myVpV(C2, C1, P1);
      myVpV(C3, C1, P2);
      myVpV(D2, D1, Q1);
      myVpV(D3, D1, Q2);
...
// from Tomas Moller's "A Fast Triangle-Triangle Intersection Test",
// Journal of Graphics Tools, 2(2), 1997
int coplanar_tri_tri(double N[3], double V0[3], double V1[3], double V2[3],
                     double U0[3], double U1[3], double U2[3]) {
  double A[3];
  short i0, i1;  // NOLINT(runtime/int)
...
#endif  // INCLUDE_MESHUTILS_TRITRIINTERSECTIONTEST_H_

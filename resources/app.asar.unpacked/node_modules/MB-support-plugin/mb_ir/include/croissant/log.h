...
#ifndef CROISSANT_LOG_H
#define CROISSANT_LOG_H
...
#define LOG_METADATA_INIT(severity_) \
  croissant::Log::Metadata(severity_, \
                          __FILE__,            \
                          __PRETTY_FUNCTION__, \
                          __LINE__, \
                          time(0))
...
/// Log an error
#define LOG_ERROR \
    croissant::Log::appendToGlobalLog(LOG_METADATA_INIT(croissant::Log::kError))

/// Log debugging info
#define LOG_INFO \
    croissant::Log::appendToGlobalLog(LOG_METADATA_INIT(croissant::Log::kInfo))

/// Log spammy debugging info
#define LOG_SPAM \
    croissant::Log::appendToGlobalLog(LOG_METADATA_INIT(croissant::Log::kSpam))
...
Log CROISSANT_API *createInMemoryLog();
...
Log CROISSANT_API *createOnDiskLog(const std::string &path);
}

#endif  // CROISSANT_LOG_H

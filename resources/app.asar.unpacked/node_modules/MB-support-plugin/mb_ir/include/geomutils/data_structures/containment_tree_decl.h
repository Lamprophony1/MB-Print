...
#ifndef INCLUDE_GEOMUTILS_DATA_STRUCTURES_CONTAINMENTTREE_DECL_H
#define INCLUDE_GEOMUTILS_DATA_STRUCTURES_CONTAINMENTTREE_DECL_H
...
public:
    ...
    /**
     @brief this is how boost templates access parent typdefs
     */
    typedef basic_containment_tree<child_type> basic_containment_tree_;
    /**
    ...
    /**
     ...
     @param loop a valid non-empty loop
     */
    basic_containment_tree(Loop&& loop);
    /**
     * @brief Move construct any type of tree
     * @param other a temporary tree from which to take values
     */
    basic_containment_tree(basic_containment_tree&& other);
    /**
     ...
     */
    child_type& select(const Vector2& point);
    /**
     @brief Return reference to deepest child that contains point,
     or to this tree if there are no such children.
     @param point the point to test for containment
     @return reference to deepest tree that contains @a point
     */
    const child_type& select(const Vector2& point) const;
    /**
...
public:
    ...
    ContainmentTree(ContainmentTree&& other);
 ...
 */
template <typename DERIVED_T>
void swap(geomutils::basic_containment_tree<DERIVED_T>& lhs,
          geomutils::basic_containment_tree<DERIVED_T>& rhs);
}

#endif /* INCLUDE_GEOMUTILS_DATA_STRUCTURES_CONTAINMENTTREE_DECL_H */

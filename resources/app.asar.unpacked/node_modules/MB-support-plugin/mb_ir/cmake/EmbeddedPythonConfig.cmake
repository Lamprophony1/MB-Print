...
if(TRUE)
    set(TARGETFILE_LIST "EmbeddedPythonTargets.cmake")
...
if(FALSE)
    set(CMAKE_INCLUDES "cmake/mustache.cmake")
...
if(FALSE)
    set(ADDITIONAL_PATH_VARS "MUSTACHE_CODEGEN_PATH;MUSTACHE_CODEGEN_SCRIPT;JACKSON_MUSTACHE_CODEGEN_SCRIPT")
    set(ADDITIONAL_PATHS ".;/mustache_codegen.py;/jackson_mustache_codegen.py")
    ...
    foreach(idx RANGE ${num_paths})
        ...
        if(DEFINED ${path_var})
            ...
            message(
                FATAL_ERROR
                "EmbeddedPythonConfig.cmake won't overwrite existing var: ${path_var}")
        endif()
...
if(EmbeddedPython_FIND_COMPONENTS)
    foreach(component ${EmbeddedPython_FIND_COMPONENTS})
        if(NOT TARGET ${component})
            set(EmbeddedPython_${component}_FOUND FALSE)
            if(EmbeddedPython_FIND_REQUIRED_${component})
                message(SEND_ERROR "EmbeddedPython::${component} not available.")
            endif()
        else()
            set(EmbeddedPython_${component}_FOUND TRUE)
        endif()
    endforeach()
endif()

check_required_components(EmbeddedPython)

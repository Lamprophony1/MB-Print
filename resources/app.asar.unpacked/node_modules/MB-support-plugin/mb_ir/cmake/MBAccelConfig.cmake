...
if(TRUE)
    set(TARGETFILE_LIST "parserTargets.cmake;ParserTargets.cmake;mbaccelTargets.cmake;MBAccelTargets.cmake")
...
if(FALSE)
    ...
    foreach(idx RANGE ${num_paths})
        ...
        if(DEFINED ${path_var})
            ...
            message(
                FATAL_ERROR
                "MBAccelConfig.cmake won't overwrite existing var: ${path_var}")
        endif()
...
if(MBAccel_FIND_COMPONENTS)
    foreach(component ${MBAccel_FIND_COMPONENTS})
        if(NOT TARGET ${component})
            set(MBAccel_${component}_FOUND FALSE)
            if(MBAccel_FIND_REQUIRED_${component})
                message(SEND_ERROR "MBAccel::${component} not available.")
            endif()
        else()
            set(MBAccel_${component}_FOUND TRUE)
        endif()
    endforeach()
endif()

check_required_components(MBAccel)

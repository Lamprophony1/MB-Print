...
if(TRUE)
    ...
    foreach(idx RANGE ${num_paths})
        ...
        if(DEFINED ${path_var})
            ...
            message(
                FATAL_ERROR
                "MBCoreUtilsConfig.cmake won't overwrite existing var: ${path_var}")
        endif()
...
if(MBCoreUtils_FIND_COMPONENTS)
    foreach(component ${MBCoreUtils_FIND_COMPONENTS})
        if(NOT TARGET ${component})
            set(MBCoreUtils_${component}_FOUND FALSE)
            if(MBCoreUtils_FIND_REQUIRED_${component})
                message(SEND_ERROR "MBCoreUtils::${component} not available.")
            endif()
        else()
            set(MBCoreUtils_${component}_FOUND TRUE)
        endif()
    endforeach()
endif()

check_required_components(MBCoreUtils)

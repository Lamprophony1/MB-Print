...
if(TRUE)
    set(TARGETFILE_LIST "fopen_hackTargets.cmake")
...
if(FALSE)
    ...
    foreach(idx RANGE ${num_paths})
        ...
        if(DEFINED ${path_var})
            ...
            message(
                FATAL_ERROR
                "FopenHackConfig.cmake won't overwrite existing var: ${path_var}")
        endif()
...
if(FopenHack_FIND_COMPONENTS)
    foreach(component ${FopenHack_FIND_COMPONENTS})
        if(NOT TARGET ${component})
            set(FopenHack_${component}_FOUND FALSE)
            if(FopenHack_FIND_REQUIRED_${component})
                message(SEND_ERROR "FopenHack::${component} not available.")
            endif()
        else()
            set(FopenHack_${component}_FOUND TRUE)
        endif()
    endforeach()
endif()

check_required_components(FopenHack)

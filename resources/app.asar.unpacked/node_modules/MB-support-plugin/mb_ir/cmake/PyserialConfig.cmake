...
if(TRUE)
    set(ADDITIONAL_PATH_VARS "pyserial")
    set(ADDITIONAL_PATHS "MakerWare/python/pyserial-4.0-py2.7.egg")
    ...
    foreach(idx RANGE ${num_paths})
        ...
        if(DEFINED ${path_var})
            ...
            message(
                FATAL_ERROR
                "PyserialConfig.cmake won't overwrite existing var: ${path_var}")
        endif()
...
if(Pyserial_FIND_COMPONENTS)
    foreach(component ${Pyserial_FIND_COMPONENTS})
        if(NOT TARGET ${component})
            set(Pyserial_${component}_FOUND FALSE)
            if(Pyserial_FIND_REQUIRED_${component})
                message(SEND_ERROR "Pyserial::${component} not available.")
            endif()
        else()
            set(Pyserial_${component}_FOUND TRUE)
        endif()
    endforeach()
endif()

check_required_components(Pyserial)

...
if(TRUE)
    set(TARGETFILE_LIST "assimpTargets.cmake;geomutilsTargets.cmake;meshutilsTargets.cmake;thingTargets.cmake;thingtoolTargets.cmake;ThingAPITargets.cmake")
...
if(TRUE)
    ...
    # arguments we need.
    set(TRANSITIVE_DEPENDENCIES "Boost REQUIRED CONFIG COMPONENTS system filesystem;OpenMesh REQUIRED CONFIG")
...
if(FALSE)
    set(ADDITIONAL_PATH_VARS "MBCoreUtils_INCLUDE_DIRS;BWCoreUtils_INCLUDE_DIRS")
    set(ADDITIONAL_PATHS "include;include/bwcoreutils")
    ...
    foreach(idx RANGE ${num_paths})
        ...
        if(DEFINED ${path_var})
            ...
            message(
                FATAL_ERROR
                "ThingConfig.cmake won't overwrite existing var: ${path_var}")
        endif()
...
if(Thing_FIND_COMPONENTS)
    foreach(component ${Thing_FIND_COMPONENTS})
        if(NOT TARGET ${component})
            set(Thing_${component}_FOUND FALSE)
            if(Thing_FIND_REQUIRED_${component})
                message(SEND_ERROR "Thing::${component} not available.")
            endif()
        else()
            set(Thing_${component}_FOUND TRUE)
        endif()
    endforeach()
endif()

check_required_components(Thing)

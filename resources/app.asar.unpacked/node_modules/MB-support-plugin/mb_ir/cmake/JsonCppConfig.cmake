...
if(TRUE)
    set(TARGETFILE_LIST "JsonCppTargets.cmake")
...
if(FALSE)
    ...
    foreach(idx RANGE ${num_paths})
        ...
        if(DEFINED ${path_var})
            ...
            message(
                FATAL_ERROR
                "JsonCppConfig.cmake won't overwrite existing var: ${path_var}")
        endif()
...
if(JsonCpp_FIND_COMPONENTS)
    foreach(component ${JsonCpp_FIND_COMPONENTS})
        if(NOT TARGET ${component})
            set(JsonCpp_${component}_FOUND FALSE)
            if(JsonCpp_FIND_REQUIRED_${component})
                message(SEND_ERROR "JsonCpp::${component} not available.")
            endif()
        else()
            set(JsonCpp_${component}_FOUND TRUE)
        endif()
    endforeach()
endif()

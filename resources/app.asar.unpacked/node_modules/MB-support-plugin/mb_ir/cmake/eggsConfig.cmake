...
if(FALSE)
    ...
    foreach(idx RANGE ${num_paths})
        ...
        if(DEFINED ${path_var})
            ...
            message(
                FATAL_ERROR
                "eggsConfig.cmake won't overwrite existing var: ${path_var}")
        endif()
...
if(eggs_FIND_COMPONENTS)
    foreach(component ${eggs_FIND_COMPONENTS})
        if(NOT TARGET ${component})
            set(eggs_${component}_FOUND FALSE)
            if(eggs_FIND_REQUIRED_${component})
                message(SEND_ERROR "eggs::${component} not available.")
            endif()
        else()
            set(eggs_${component}_FOUND TRUE)
        endif()
    endforeach()
endif()

check_required_components(eggs)

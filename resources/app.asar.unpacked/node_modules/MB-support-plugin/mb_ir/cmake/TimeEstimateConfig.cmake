...
if(TRUE)
    set(TARGETFILE_LIST "parserTargets.cmake;ParserTargets.cmake;mbaccelTargets.cmake;MBAccelTargets.cmake;time_estTargets.cmake;TimeEstimateTargets.cmake")
...
if(FALSE)
    ...
    foreach(idx RANGE ${num_paths})
        ...
        if(DEFINED ${path_var})
            ...
            message(
                FATAL_ERROR
                "TimeEstimateConfig.cmake won't overwrite existing var: ${path_var}")
        endif()
...
if(TimeEstimate_FIND_COMPONENTS)
    foreach(component ${TimeEstimate_FIND_COMPONENTS})
        if(NOT TARGET ${component})
            set(TimeEstimate_${component}_FOUND FALSE)
            if(TimeEstimate_FIND_REQUIRED_${component})
                message(SEND_ERROR "TimeEstimate::${component} not available.")
            endif()
        else()
            set(TimeEstimate_${component}_FOUND TRUE)
        endif()
    endforeach()
endif()

check_required_components(TimeEstimate)

...
if(TRUE)
    set(ADDITIONAL_PATH_VARS "s3g;avrdude_path;avrdude_conf_path")
    set(ADDITIONAL_PATHS "MakerWare/python34/Lib/site-packages/makerbot_driver-0.1.1-py3-none-any.whl;MakerWare/avrdude.exe;MakerWare/avrdude.conf")
    ...
    foreach(idx RANGE ${num_paths})
        ...
        if(DEFINED ${path_var})
            ...
            message(
                FATAL_ERROR
                "S3gConfig.cmake won't overwrite existing var: ${path_var}")
        endif()
...
if(S3g_FIND_COMPONENTS)
    foreach(component ${S3g_FIND_COMPONENTS})
        if(NOT TARGET ${component})
            set(S3g_${component}_FOUND FALSE)
            if(S3g_FIND_REQUIRED_${component})
                message(SEND_ERROR "S3g::${component} not available.")
            endif()
        else()
            set(S3g_${component}_FOUND TRUE)
        endif()
    endforeach()
endif()

check_required_components(S3g)

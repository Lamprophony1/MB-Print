...
if(TRUE)
    set(TARGETFILE_LIST "CroissantTargets.cmake")
...
if(FALSE)
    ...
    foreach(idx RANGE ${num_paths})
        ...
        if(DEFINED ${path_var})
            ...
            message(
                FATAL_ERROR
                "CroissantConfig.cmake won't overwrite existing var: ${path_var}")
        endif()
...
if(Croissant_FIND_COMPONENTS)
    foreach(component ${Croissant_FIND_COMPONENTS})
        if(NOT TARGET ${component})
            set(Croissant_${component}_FOUND FALSE)
            if(Croissant_FIND_REQUIRED_${component})
                message(SEND_ERROR "Croissant::${component} not available.")
            endif()
        else()
            set(Croissant_${component}_FOUND TRUE)
        endif()
    endforeach()
endif()

check_required_components(Croissant)

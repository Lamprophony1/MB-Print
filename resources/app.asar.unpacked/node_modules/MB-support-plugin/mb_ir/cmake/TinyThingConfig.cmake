...
if(TRUE)
    set(TARGETFILE_LIST "tinythingTargets.cmake;dot_makerbot_writerTargets.cmake")
...
if(FALSE)
    ...
    foreach(idx RANGE ${num_paths})
        ...
        if(DEFINED ${path_var})
            ...
            message(
                FATAL_ERROR
                "TinyThingConfig.cmake won't overwrite existing var: ${path_var}")
        endif()
...
if(TinyThing_FIND_COMPONENTS)
    foreach(component ${TinyThing_FIND_COMPONENTS})
        if(NOT TARGET ${component})
            set(TinyThing_${component}_FOUND FALSE)
            if(TinyThing_FIND_REQUIRED_${component})
                message(SEND_ERROR "TinyThing::${component} not available.")
            endif()
        else()
            set(TinyThing_${component}_FOUND TRUE)
        endif()
    endforeach()
endif()

check_required_components(TinyThing)

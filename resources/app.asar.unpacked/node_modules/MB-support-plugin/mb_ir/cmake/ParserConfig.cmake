...
if(TRUE)
    set(TARGETFILE_LIST "parserTargets.cmake;ParserTargets.cmake")
...
if(FALSE)
    ...
    foreach(idx RANGE ${num_paths})
        ...
        if(DEFINED ${path_var})
            ...
            message(
                FATAL_ERROR
                "ParserConfig.cmake won't overwrite existing var: ${path_var}")
        endif()
...
if(Parser_FIND_COMPONENTS)
    foreach(component ${Parser_FIND_COMPONENTS})
        if(NOT TARGET ${component})
            set(Parser_${component}_FOUND FALSE)
            if(Parser_FIND_REQUIRED_${component})
                message(SEND_ERROR "Parser::${component} not available.")
            endif()
        else()
            set(Parser_${component}_FOUND TRUE)
        endif()
    endforeach()
endif()

check_required_components(Parser)
